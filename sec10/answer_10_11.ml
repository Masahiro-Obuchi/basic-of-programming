...
(* テスト *)
let test0 = get_ekikan_kyori "代々木上原" "代々木公園" global_ekikan_list = 1.0

let test1 = get_ekikan_kyori "代々木公園" "明治神宮前" global_ekikan_list = 1.2

let test2 = get_ekikan_kyori "九段下" "飯田橋" global_ekikan_list = 0.7
let test3 = get_ekikan_kyori "高田馬場" "落合" global_ekikan_list = 1.9
let test4 = get_ekikan_kyori "池袋" "要町" global_ekikan_list = 1.2
let test5 = get_ekikan_kyori "高崎" "渋谷" global_ekikan_list = infinity
