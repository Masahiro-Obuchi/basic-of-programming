...
let test2 = filter_even [1; 2; 3; 4; 5] = [2; 4]
...
(* テスト *)
let test3 = filter_count_A [] = 0
let test4 = filter_count_A [{namae = "asai"; tensuu = 70; seiseki = "B"}] = 0
let test5 = filter_count_A [{namae = "asai"; tensuu = 70; seiseki = "B"}; {namae = "kaneko"; tensuu = 85; seiseki = "A"}] = 1
let test6 = filter_count_A [{namae = "asai"; tensuu = 70; seiseki = "B"}; {namae = "kaneko"; tensuu = 85; seiseki = "A"}; {namae = "yoshida"; tensuu = 80; seiseki = "A"}] = 2
...
let concat_local_func lst = let concat first rest_result = first ^ rest_result in List.fold_right concat lst ""
 (* テスト *)
let test7 = concat_fold_right [] = ""
let test8 = concat_fold_right [ "テンプレート" ] = "テンプレート"
let test9 = concat_fold_right [ "テンプレート"; "の" ] = "テンプレートの"
let test10 = concat_fold_right [ "テンプレート"; "の"; "複合" ] = "テンプレートの複合"
let test11 = concat_fold_right [ "テンプレート"; "の"; "複合"; "データ" ] = "テンプレートの複合データ"
...
(* テスト *)
let test12 = gakusei_sum [] = 0
let test13 = gakusei_sum [{namae = "asai"; tensuu = 70; seiseki = "B"}] = 70
let test14 = gakusei_sum [{namae = "asai"; tensuu = 70; seiseki = "B"}; {namae = "kaneko"; tensuu = 85; seiseki = "A"}] = 155
let test15 = gakusei_sum [{namae = "asai"; tensuu = 70; seiseki = "B"}; {namae = "kaneko"; tensuu = 85; seiseki = "A"}; {namae = "yoshida"; tensuu = 80; seiseki = "A"}] = 235
